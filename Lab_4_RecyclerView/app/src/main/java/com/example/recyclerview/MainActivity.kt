...
class MainActivity : AppCompatActivity(), CellClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ColorList.add(ColorData("White",Color.parseColor("#ffffff")))
        ColorList.add(ColorData("Black",Color.parseColor("#000000")))
        ColorList.add(ColorData("Blue", Color.parseColor("#000eff")))
        ColorList.add(ColorData("Red", Color.parseColor("#ff0220")))
        ColorList.add(ColorData("Magneta", Color.parseColor("#e014d5")))
